...
class CreateBdFeasiRncCalSalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bd_feasi_rnc_cal_sales', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bd_feasi_rnc_cal_sales');
    }
}
