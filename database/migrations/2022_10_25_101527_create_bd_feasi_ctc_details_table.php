...
class CreateBdFeasiCtcDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bd_feasi_ctc_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('feasi_ctc_id');
            $table->foreign('feasi_ctc_id')->on('bd_feasibility_ctcs')->references('id')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('bd_feasi_ctc_details');
    }
}
