...
class CreateBdFeasiRncCalRatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bd_feasi_rnc_cal_rates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bd_feasi_rnc_cal_rates');
    }
}
