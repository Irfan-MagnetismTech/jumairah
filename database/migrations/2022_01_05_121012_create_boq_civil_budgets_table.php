...
class CreateBoqCivilBudgetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('boq_civil_budgets', function (Blueprint $table)
        {
            $table->id();
            ...
            $table->tinyInteger('is_additional_material')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('boq_civil_budgets');
    }
}
