...
class CreateBoqEmeWorkorderTermsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('boq_eme_workorder_terms', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('boq_eme_workorder_terms');
    }
}
