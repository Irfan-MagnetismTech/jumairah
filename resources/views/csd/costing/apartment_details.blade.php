...
@section('breadcrumb-button')
    ...
    <a href="{{ url("csd/csd_approval/$costing_id/1") }}" data-toggle="tooltip" title="Approval" class="btn btn-sm btn-outline-success">Approval</a>
    ...
    @if($project->approval()->doesntExist())
        <a href="{{ url("csd/costing/$costing_id/edit") }}" title="Edit" class="btn btn-out-dashed btn-sm btn-primary"><i class="fas fa-pen"></i></a>
    @endif()
    <a href="{{ url('csd/csd-final-costing-pdf') }}/{{ $costing_id }}" data-toggle="tooltip" title="Create Pdf" class="btn btn-out-dashed btn-sm btn-warning"><i class="fas fa-file-pdf"></i></a>
    <a href="{{ url("finalCostingLog/$costing_id/log") }}" data-toggle="tooltip" title="Logs" class="btn btn-dark"><i class="fas fa-history"></i></a>
                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <tr>
                                <td><p style="text-align: left; padding-left:0px; font-size: 12px">In Words: <b>{{ ucfirst((new NumberFormatter('en', NumberFormatter::SPELLOUT))->format(round(abs($total)))) }} only</b></p></td>
                            </tr>
                            {{-- <tr>
