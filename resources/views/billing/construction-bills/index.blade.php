...
@section('title', 'Construction Bill List')
        ...
        <table id="dataTable" class="table table-striped table-bordered">
            ...
            @if ($constructionBill->is_saved == 1 || (auth()->user()->id == $constructionBill->user_id && $constructionBill->is_saved == 0))
                <tr>
                    ...
                    <td>{{$constructionBill->workorderRates?->work_level ?? null}}</td>
                    ...
                    @php
                        ...
                        $TotalApproval = \App\Approval\ApprovalLayerDetails::whereHas('approvalLayer', function ($q)use($constructionBill){ $q->where([['name','CONSTRUCTION BILL'],['department_id',$constructionBill->preparedBy->department_id]]);
                        ...
                        <div class="icon-btn">
                            <nobr>
                                ...
                                @else
                                    ...
                                    <a href="{{ url("construction-bill-approval/$constructionBill->id/1") }}" data-toggle="tooltip" title="Approval" class="btn btn-outline-success">Approve</a>
                                    @endif
                                ...
                                @else
                                    ...
                                    @endif
                                @endif --}}
                                <a href="{{ url("constructionbillLog/$constructionBill->id/log") }}" data-toggle="tooltip" title="Logs" class="btn btn-dark"><i class="fas fa-history"></i></a>
