...
<body>
    ...
    <div class="address">
        ...
        <p>The Management of <span style="font-weight: bold;"> "{!! htmlspecialchars(config('company_info.company_fullname')) !!}"</span> is pleased to inform you that against your offer, you have been awarded the "Work Order"
