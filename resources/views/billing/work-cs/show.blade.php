...
@section('breadcrumb-title')
    Showing information of CS# {{$workC->id}}
@endsection
        ...
        <div class="col-lg-12">
            <div class="table-responsive">
                <table id="dataTable" class="table table-striped table-bordered">
                    ...
                    <tr style="background-color: #0C4A77;;color: white;"><td> <strong>Cs No.</strong> </td> <td> <strong>CS#{{ $workC->id}}</strong></td></tr>
                    <tr><td> <strong>Effective Date</strong> </td> <td>  {{ $workC->effective_date}}</td></tr>
                    <tr><td> <strong>Expiry Date</strong> </td> <td>  {{ $workC->expiry_date}}</td></tr>
                    <tr><td> <strong>Remarks</strong> </td> <td>  {{ $workC->remarks}}</td></tr>
                    <tr>
