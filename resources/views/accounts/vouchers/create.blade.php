...
@section('content')
    ...
    @endif
            ...
            <div class="row py-2">
                <div class="col-4">
                    <div class="input-group input-group-sm input-group-primary">
                        ...
                        {{Form::select('voucher_type', $types, old('voucher_type') ? old('voucher_type') : (!empty($voucher) ? $voucher->voucher_type : null),['class' => 'form-control','id' => 'voucher_type', 'placeholder'=>" Voucher Type", 'autocomplete'=>"off", ""])}}
                    </div>
                </div>
                <div class="col-4">
                    <div class="input-group input-group-sm input-group-primary">
        ...
        @php
           ...
           // dump($voucher->ledgerEntries->pluck('ref_bill')[0])
        @endphp
        {{-- {{dd($account_id[0])}} --}}
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                ...
                                <div class="input-group">
                                    {{Form::select('ref_bill[]',$refBills,$ref_bill[$key], ['class' => 'form-control account','id' => 'account', 'placeholder'=>'Enter Bill', 'autocomplete'=>"off" ,$readonly])}}
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group input-group-sm input-group-primary">
                                ...
                                {{Form::select('cheque_type',['A/C Payee' => 'A/C Payee','Cheque' => 'Cheque','Cash' =>'Cash','Pay Order' =>'Pay Order','Draft' =>'Draft','Same / Inter Bank' =>'Same / Inter Bank'], old('cheque_type') ? old('cheque_type') : (!empty($voucher) ? $voucher->cheque_type : null),['class' => 'form-control','id' => 'cheque_type', 'placeholder' => 'Payment Type', 'autocomplete'=>"off", 'rows'=>2])}}
                            </div>
                        </td>
                        <td colspan="2">
                            <div class="input-group input-group-sm input-group-primary">
        ...
        $(function(){
            ...
            function changeBill(thisRow, balance_line){
                if (balance_line == 34){
                    ...
                    let costCenter_id = thisRow.closest('tr').find('.cost_center_id').val();
                    const url = '{{url("unpaidBill")}}/' + account_Id + '/' + costCenter_id;
