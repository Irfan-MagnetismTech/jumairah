...
@section('breadcrumb-button')
    @can('project-create')
        <a href="{{ route('eme.load_calculations.total_view', ['project' => $project ]) }}" data-toggle="tooltip" title="Index" class="btn btn-out-dashed btn-sm btn-primary"><i class="fas fa-eye"></i></a>
        <a href="{{ route('eme.load_calculations.pdf', ['project' => $project ]) }}" data-toggle="tooltip" title="PDF" class="btn btn-out-dashed btn-sm btn-success"><i class="fas fa-file-pdf"></i></a>
