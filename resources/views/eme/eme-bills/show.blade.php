...
@section('title', 'EME Bill Details')
        ...
        <div class="col-lg-12">
            {{-- <div class="table-responsive">
                <table id="dataTable" class="table table-striped table-bordered">
                    ...
                    <tr><td> <     >Supplier Name</strong> </td> <td>{{$constructionBill->supplier->name}}</td></tr>
                        ...
                        @foreach ($All_dates as $key => $value)
                            ...
                            @if(isset($allConstructionBill[$value]))
                                @foreach ($allConstructionBill[$value] as $key3 => $value3)
                                    <tr>
                                        <td class="textCenter">{{addOrdinalNumberSuffix($bill_no)}} Bill ( {{$value3->emeWorkorder->workorder_for ?? ''}}) </td>
                                        <td class="textCenter">Tk.</td>
