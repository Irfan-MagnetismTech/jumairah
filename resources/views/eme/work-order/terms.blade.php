...
@section('breadcrumb-button')
        <a href="{{ url("eme/work_order/$workorder->id/edit") }}" data-toggle="tooltip" title="Edit Rate" class="btn btn-out-dashed btn-sm btn-info" data-toggle="tooltip" title="Edit Rate"><i class="fas fa-long-arrow-alt-left"></i></a>
        <a href="{{route("eme.workorder.technical_specification", ['workorder' => $workorder->id]) }}" data-toggle="tooltip" title="Edit Technical Specification" class="btn btn-out-dashed btn-sm btn-info"><i class="fas fa-long-arrow-alt-right"></i></a>
...
@section('content')
    {!! Form::open(['url' => route('eme.workorder.terms.store',['workorder' => $workorder->id]), 'method' => 'POST', 'class' => 'custom-form']) !!}
