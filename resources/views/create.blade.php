    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="input-group input-group-sm input-group-primary">
                ...
                {{Form::text('date', old('date') ? old('date') : (!empty($followup->date) ? $followup->date : null),['class' => 'form-control','id' => 'date', 'autocomplete'=>"off",'required','placeholder'=>'dd-mm-yyyy'])}}
            </div>
        </div>
        <div class="col-xl-4 col-md-6">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="time_from">Time From<span class="text-danger">*</span></label>
                {{Form::time('time_from', old('time_from') ? old('time_from') : (!empty($followup->time_from) ? $followup->time_from : null),['class' => 'form-control','id' => 'time_from', 'autocomplete'=>"off",'required'])}}
            </div>
        </div>
        <div class="col-xl-4 col-md-6">
            <div class="input-group input-group-sm input-group-primary">
