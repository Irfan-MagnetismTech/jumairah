...
{{--    <link rel="stylesheet" type="text/css" href="{!! asset('theme/pages/data-table/css/buttons.dataTables.min.css') !!}">--}}
...
{{--    <script src="{!! asset('theme/pages/data-table/js/jszip.min.js') !!}"></script>--}}
{{--    <script src="{!! asset('theme/pages/data-table/js/pdfmake.min.js') !!}"></script>--}}
{{--    <script src="{!! asset('theme/pages/data-table/js/vfs_fonts.js') !!}"></script>--}}
