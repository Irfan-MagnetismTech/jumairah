    ...
    <div>
        ...
        <div class="container" style="clear: both; display: block; width: 96%;">
            <div style="text-align: center !important; position: relative;">
                <div>
                    <div style="float: left;">Ref: {!! strtoupper(htmlspecialchars(config('company_info.company_fullname'))) !!}/ {{$ScrapCsMaterialSupplier->first()->Cs->reference_no}}</div>
                ...
                The management of {!! strtoupper(htmlspecialchars(config('company_info.company_fullname'))) !!}. is pleased to inform you that you have been selected for Scrap sale against your offer. The terms & condition and rates for the work are summarized below.
                </div>
