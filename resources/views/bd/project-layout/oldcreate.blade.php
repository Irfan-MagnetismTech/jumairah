...
@section('content')
    ...
    <div class="row">
                    ...
                    @if (old('material_id'))
                        @foreach (old('material_id') as $key => $materialOldData)
                            <tr>
                                ...
                                <td><input type="text" name="proposed_road[]" value="{{ old('proposed_road')[$key] }}" class="form-control form-control text-center form-control-sm proposed_road" autocomplete="off"></td>
                    ...
                    @elseif(count($previous_data))
                            @foreach ($previous_data->first()->road_details as $key => $OldData)
                                <tr>
                                    ...
                                    <td><input type="text" name="proposed_road[]" value="{{ $OldData?->proposed_road ?? 0 }}" class="form-control form-control text-center form-control-sm proposed_road" autocomplete="off"></td>
        ...
        <div class="col-xl-3 col-md-3">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="proposed_road_width">width<span
                        class="text-danger">*</span></label>
                {{ Form::number('proposed_road_width', old('proposed_road_width') ? old('proposed_road_width') : (!empty($projectLayout->first()->proposed_road_width) ? $projectLayout->first()->proposed_road_width : null), ['class' => 'form-control proposed_road_width', 'id' => 'proposed_road_width', 'autocomplete' => 'off', 'required', 'min' => 0, 'max' => 100, 'step' => 0.01]) }}
            </div>
        </div>
        <div class="col-xl-3 col-md-3"></div>
        ...
        <div class="col-xl-2 col-md-2">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="total_basement_floor">Floor<span
                        class="text-danger">*</span></label>
                {{ Form::number('total_basement_floor', old('total_basement_floor') ? old('total_basement_floor') : (count($previous_data) ? $previous_data->first()->total_basement_floor : null), ['class' => 'form-control form-control-sm total_basement_floor text-center', 'id' => 'total_basement_floor']) }}
            </div>
        </div>
        <div class="col-xl-2 col-md-2">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="percentage">Percent<span class="text-danger">*</span></label>
                {{ Form::number('percentage', old('percentage', $purchaseOrder->percentage ?? null), ['class' => 'form-control form-control-sm percentage text-center', 'id' => 'percentage', 'placeholder' => '75%', 'readonly', 'tabindex' => '-1']) }}
            </div>
        </div>
        <div class="col-xl-3 col-md-3">
            <div class="input-group input-group-sm input-group-primary">
        ...
        <div class="col-xl-2 col-md-2">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="front_ver_spc_per">Feet<span class="text-danger">*</span></label>
                {{ Form::number('front_ver_spc_per', old('front_ver_spc_per', $purchaseOrder->front_ver_spc_per ?? null), ['class' => 'form-control form-control-sm front_ver_spc_per text-center', 'id' => 'front_ver_spc_per', 'placeholder' => '2.5%', 'readonly', 'tabindex' => '-1']) }}
            </div>
        </div>
        <div class="col-xl-3 col-md-3">
            <div class="input-group input-group-sm input-group-primary">
        ...
        <div class="col-xl-2 col-md-2">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="front_verenda_percent">Percent<span
                        class="text-danger">*</span></label>
                {{ Form::number('front_verenda_percent', old('front_verenda_percent', $purchaseOrder->front_verenda_percent ?? null), ['class' => 'form-control form-control-sm front_verenda_percent text-center', 'id' => 'front_verenda_percent', 'placeholder' => '30%', 'readonly', 'tabindex' => '-1']) }}
            </div>
        </div>
        <div class="col-xl-2 col-md-2">
            <div class="input-group input-group-sm input-group-primary">
                <label class="input-group-addon" for="front_ver_spc_per">Feet<span class="text-danger">*</span></label>
                {{ Form::number('front_ver_spc_per', old('front_ver_spc_per', $purchaseOrder->front_ver_spc_per ?? null), ['class' => 'form-control form-control-sm front_ver_spc_per text-center', 'id' => 'front_ver_spc_per', 'placeholder' => '3.25', 'readonly', 'tabindex' => '-1']) }}
            </div>
        </div>
        <div class="col-xl-3 col-md-3">
            <div class="input-group input-group-sm input-group-primary">
...
@section('script')
    <script>
        ...
        $('input[type=radio][name=far_for], #proposed_road_width').on('change', function() {
            gerFarValue();
            // calculateFar();
            calculateTotalFar()
        });
        ...
        function calculateTotalFar() {
            ...
            let total_basement_floor_area = (applicable_land_area * 0.75 * total_basement_floor);
            let total_front_verenda = (front_verenda_feet * 0.30 * 3.25);
            let total_side_verenda = (proposed_total_area * 0.025);
        ...
        function totalOperation() {
            ...
            $("#modified_far").val(modification_far.toFixed(2))
        ...
        $(document).on('keyup change', '.modified_far, .proposed_mgc, .front_verenda_feet, .total_basement_floor',
            function() {
                calculateTotalFar();
            });
