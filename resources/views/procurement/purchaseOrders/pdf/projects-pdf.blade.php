...
<body>
            ...
            <div class="row">
                ...
                <div class="head4">
                    <table>
                        ...
                        <tr>
                            <td>
                                <p style="font-size:12px">Receiver Name</p>
                            </td>
                            <td>
                                <p style="font-size:12px">:</p>
                            </td>
                            <td>
                                <p style="font-size:12px">{{ $purchaseOrder->receiver_name ?? '---' }}</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p style="font-size:12px">Receiver Contact</p>
                            </td>
                            <td>
                                <p style="font-size:12px">:</p>
                            </td>
                            <td>
                                <p style="font-size:12px">{{ $purchaseOrder->receiver_contact ?? '---' }}</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <table role="presentation" style="margin: 0px auto; border-collapse: collapse; border: 0; border-spacing: 0; margin-top: 10px">
            <tr>
                <td style="width: 630px; vertical-align: top; color: #000;border: 1px solid #000;padding: 1rem; margin: 10px">
