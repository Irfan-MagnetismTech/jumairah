...
@section('content')
    <div class="row">
            ...
            <div class="table-responsive">
                <table id="dataTable" class="table table-striped table-bordered">
                    <tbody class="text-left">
                        ...
                        <tr>
                            <td> <strong>Apartment Rate</strong> </td>
                            <td> @money($sell->apartment_rate)</td>
                        </tr>
                        <tr>
                            <td> <strong>Apartment Price</strong> </td>
                            <td> @money($sell->apartment_value)</td>
                        </tr>
                        <tr>
                            <td> <strong>No. of Parking</strong> </td>
                            <td> {{ $sell->parking_no }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Total Parking Price</strong> </td>
                            <td> @money($sell->parking_price)</td>
                        </tr>
                        <tr>
                            <td> <strong>No. of Utility</strong> </td>
                            <td> {{ $sell->utility_no }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Utility Rate</strong> </td>
                            <td> @money($sell->utility_fees)</td>
                        </tr>
                        <tr>
                            <td> <strong>Utility Price</strong> </td>
                            <td> @money($sell->utility_price)</td>
                        </tr>
                        <tr>
                            <td> <strong>No. of Reserve</strong> </td>
                            <td> {{ $sell->reserve_no }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Reserve Rate</strong> </td>
                            <td> @money($sell->reserve_rate)</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td> @money($sell->others)</td>
                        </tr>
                        <tr>
                            <td> <strong>Total Apartment Value</strong> </td>
                            <td> @money($sell->total_value)</td>
                        </tr>
                        <tr>
                            <td> <strong>Booking Amount</strong> </td>
                            <td> @money($sell->booking_money)</td>
                        </tr>
                        <tr>
                            <td> <strong>Booking Date</strong> </td>
                            <td> {{ $sell->booking_money_date }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Down Payment Date</strong></td>
                            <td> @money($sell->downpayment)</td>
                        </tr>
                        <tr>
                            <td> <strong>Down Payment</strong></td>
                            <td> {{ $sell->downpayment_date }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Remaining Amount</strong></td>
                            <td> @money($sell->installment)</td>
                        </tr>
                        <tr>
                            <td> <strong>No of Installment</strong></td>
                            <td> {{ $sell->installmentList->count() }}</td>
                        </tr>
                        <tr>
        ...
        <div class="col-lg-6">
            <div class="table-responsive">
                <table id="dataTable" class="table table-striped table-bordered">
                    @foreach ($saleClients as $sellClient)
                        <tbody class="text-left">
                            <tr style="background-color: #0C4A77">
                                ...
                                <td>
                                    <a href="{{ route('clients.show', $sellClient->client->id) }}"
                                        class="text-white"><strong>{{ $sellClient->client->name }}</strong></a>
                                </td>
                            </tr>
                            <tr>
                                <td> Contact</td>
                            ...
                            <tr>
                                <td> Address</td>
                                <td> {{ $sellClient->client->present_address }} </td>
                            </tr>
                            <tr>
                                <td> Email</td>
                                <td> {{ $sellClient->client->email }} </td>
                            </tr>
                            <tr>
                                <td> Picture</td>
                                <td>
                                    @if ($sellClient->client->picture)
                                        <img src="{{ asset("storage/$sellClient->client->picture") }}" alt=""
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('payment-details-pdf', $sell->id) }}" target="_blank" style="color: red"><i
            ...
            @if (!empty($sell->saleCancellation))
                <div class="row">
                    <div class="col-lg-12">
                        <p class="text-center font-weight-bold m-b-0">Cancellations Info</p>
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th style="background-color: #0C4A77;">Particular</th>
                                        <th style="background-color: #0C4A77;">Date</th>
                                        <th style="background-color: #0C4A77;">Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="text-right"> @money($paidAmt = $sell->saleCancellation ? $sell->saleCancellation->paid_amount : 0)</td>
                                    </tr>
                                    <tr>
                                        <td>Deduct Amount</td>
                                        <td></td>
                                        <td class="text-right">(- ) @money($deduct = $sell->saleCancellation ? $sell->saleCancellation->deducted_amount : 0)</td>
                                    </tr>
                                    <tr>
                                        <td><b>Refund Amount</b></td>
                                        <td></td>
                                        <td class="text-right"> <b>@money($sell->saleCancellation ? $payableAmount : 0)</b></td>
                                    </tr>
                                    @foreach ($payables as $payable)
                                        <tr>
                                            <td>Refund - {{ $loop->iteration }}</td>
                                            <td>{{ $payable->transaction->transaction_date ?? '' }}</td>
                                            <td class="text-right"> @money($payable->dr_amount ?? 0)</td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        <td><b>Total </b></td>
                                        <td></td>
                                        <td class="text-right"> <b>@money($totalPayable = $payables->sum('dr_amount') ?? 0)</b></td>
                                    </tr>
                                    <tr>
                                        <td><b>Refund Balance </b></td>
                                        <td></td>
                                        <td class="text-right"> <b>@money($payableAmount - $totalPayable)</b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        @forelse($sell->bookingMoneyCollections as $bookingMoneyCollection)
                            <tr>
                                @if ($loop->first)
                                    ...
                                    <td rowspan="{{ $rowCount }}"><strong>{{ $sell->booking_money_date }}</strong>
                                    </td>
                                    <td rowspan="{{ $rowCount }}" class="text-right">
                                        <strong>@money($sell->booking_money)</strong>
                                    </td>
                                @endif
                                ...
                                @php($bid = $bookingMoneyCollection->salesCollection->id)
                                <td>
                                    <div class="icon-btn">
                                        @can('sales-collection-approval-create')
                                            @if (in_array($bookingMoneyCollection->salesCollection->payment_status, ['Dishonored', 'Received', 'Hold']))
                                                <a href="{{ url("salescollectionapproval/$bid") }}" data-toggle="tooltip"
                                                    target="_blank" title="Approve Collection "
                                                    class="btn btn-outline-success btn-sm"><i class="fas fa-plus"></i></a>
                                            @endif
                                        @endcan
                                    </div>
                                </td>
                        ...
                        @forelse($sell->downpaymentCollections as $downpaymentCollection)
                            <tr>
                                @if ($loop->first)
                                    ...
                                    <td rowspan="{{ $totalDownpayments }}"><strong>{{ $sell->downpayment_date }}</strong>
                                    </td>
                                    <td rowspan="{{ $totalDownpayments }}" class="text-right">
                                        <strong>@money($sell->downpayment)</strong>
                                    </td>
                                @endif
                                ...
                                @php($dpid = $downpaymentCollection->salesCollection->id)
                                <td>
                                    <div class="icon-btn">
                                        @can('sales-collection-approval-create')
                                            @if (in_array($downpaymentCollection->salesCollection->payment_status, ['Dishonored', 'Received', 'Hold']))
                                                <a href="{{ url("salescollectionapproval/$dpid") }}" target="_blank"
                                                    data-toggle="tooltip" title="Approve Collection "
                                                    class="btn btn-outline-success btn-sm"><i class="fas fa-plus"></i></a>
                                            @endif
                                        @endcan
                                    </div>
                            ...
                            @forelse($installment->installmentCollections as $installmentCollection)
                                <tr>
                                    @if ($loop->first)
                                        ...
                                        <td rowspan="{{ $countRow }}">
                                            <strong>{{ $installment->installment_date }}</strong>
                                        </td>
                                        <td rowspan="{{ $countRow }}" class="text-right">
                                            <strong>@money($installment->installment_amount)</strong>
                                        </td>
                                    @endif
                                    ...
                                    @php($insid = $installmentCollection->salesCollection->id)
                                    <td>
                                        <div class="icon-btn">
                                            @can('sales-collection-approval-create')
                                                @if (in_array($installmentCollection->salesCollection->payment_status, ['Dishonored', 'Received', 'Hold']))
                                                    <a href="{{ url("salescollectionapproval/$insid") }}"
                                                        data-toggle="tooltip" title="Approve Collection " target="_blank"
                                                        class="btn btn-outline-success btn-sm"><i class="fas fa-plus"></i></a>
                                                @endif
                                            @endcan
                                        </div>
        ...
        <div class="col-lg-12">
            <div class="bg-info mt-2 my-0 p-1">
                <h5 class="text-center"> Services & Others Collections </h5>
            </div>
            <div class="table-responsive">
                <table id="dataTable" class="table table-bordered text-center">
                    <thead>
                    ...
                    <tbody>
                        @foreach ($services as $key => $service)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $service->salesCollection->received_date }}</td>
                                <td>{{ $service->particular }}</td>
                                <td class="text-right">{{ $service->amount }}</td>
                                <td class="">{{ $service->salesCollection->payment_mode }}</td>
                                <td class="">{{ $service->salesCollection->source_name }}</td>
                                <td class="">{{ $service->salesCollection->transaction_no }}</td>
                                <td class="">{{ $service->salesCollection->dated }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot class="text-right">
                        <tr class="bg-warning">
                            ...
                            <td class="text-right"> <strong>
                                    {{-- @money($sell->booking_money + $sell->downpayment + $sell->installmentList->sum('installment_amount')) </strong> --}}
                            </td>
