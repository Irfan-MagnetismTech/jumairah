...
<div class="container">
    ...
    <table width="100%">
        <tr>
            <td> Ref: <strong>Ranks FC /CSD/{{$sell->apartment->project->shortName}}/{{date('d/m/y', strtotime(now()))}}</strong> </td>
    ...
    <div id="advice">
        ...
        <ul>
            ...
            <li>
                ...
                settled off. if the payments are delayed beyond 90 days, Ranks FC may exercise its right to cancel the allotment.
            </li>
            <li>
