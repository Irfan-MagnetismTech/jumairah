...
<div class="container">
    ...
    <table width="100%">
        <tr>
            <td> Ref: <strong>{!! htmlspecialchars(config('company_info.company_shortname')) !!}/CSD/{{$salesCollection->sell->apartment->project->shortName}}/{{date('d/m/y', strtotime(now()))}}</strong> </td>
