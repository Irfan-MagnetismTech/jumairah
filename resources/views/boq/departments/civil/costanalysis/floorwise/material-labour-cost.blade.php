...
@section('content')
    ...
    <div class="row">
        ...
        <form action="{{ route('boq.project.departments.civil.cost_analysis.floor_wise.material_labour.costs', ['project' => $project]) }}" method="get" class="col-md-12">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <a type="button" class="py-2 btn btn-info btn-round btn-block" href="{{ route('boq.project.departments.civil.cost_analysis.floor_wise.material_labour.costs', ['project' => $project]) }}">Clear</a>
                    </div>
                </div>
            </div>
            <hr>
        ...
        <div class="col-md-12">
            <a style="float: right" target="_blank" href="{{ route('boq.project.departments.civil.cost_analysis.floor_wise.download.material-labour.costs', ['project' => $project]) }}" data-toggle="tooltip" title="" class="btn btn-outline-danger" data-original-title="Download PDF"><i class="fas fa-file-pdf"></i></a>
            ...
            <div class="table-responsive">
                <table id="work-table" class="table table-striped table-bordered">
                    ...
                    <tr>
                        <th colspan="8">
                            <h6>Material Labour Cost Floorwise</h6>
...
{{--                                                <strong>{{ $item?->boqWork?->name ?? '---' }}</strong>--}}
                                                <strong>
                                                    <a href="{{ route('boq.project.departments.civil.calculations.edit', ['project' => $project, 'calculation_type' => 'material-labour', 'calculation' => $item]) }}">
                                                        {{ $item?->boqWork?->name ?? '---' }}
                                                    </a>
                                                </strong>
                                            </td>
