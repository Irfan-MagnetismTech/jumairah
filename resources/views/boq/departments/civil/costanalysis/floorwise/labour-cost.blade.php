...
@section('content')
    ...
    <div class="row">
        ...
        <form action="{{ route('boq.project.departments.civil.cost_analysis.floor_wise.labour.costs', ['project' => $project]) }}" method="get" class="col-md-12">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <a type="button" class="py-2 btn btn-info btn-round btn-block" href="{{ route('boq.project.departments.civil.cost_analysis.floor_wise.labour.costs', ['project' => $project]) }}">Clear</a>
                    </div>
                </div>
            </div>
            <hr>
        ...
        <div class="col-md-12">
            <a style="float: right" target="_blank" href="{{ route('boq.project.departments.civil.cost_analysis.floor_wise.download.labour.costs', ['project' => $project]) }}" data-toggle="tooltip" title="" class="btn btn-outline-danger" data-original-title="Download PDF"><i class="fas fa-file-pdf"></i></a>
                                    ...
                                    <tr>
                                        @if ($loop->first)
                                            ...
                                            <td style="text-align: center" class="bg-white" rowspan="{{ $row_span }}">
                                                <strong>
                                                    <a href="{{ route('boq.project.departments.civil.calculations.edit', ['project' => $project, 'calculation_type' => 'labour', 'calculation' => $item]) }}">
                                                        {{ $item?->boqWork?->name ?? '---' }}
                                                    </a>
                                                </strong>
                                            </td>
