...
<div class="container">
    <div class="row">
        <table id="table" class="text-center">
            <thead>
            <tr>
                <th colspan="8">PERCENTAGE SHEET FLOOR WISE</th>
            </tr>
            <tr>
                <th>SL.</th>
                <th>Description Of Particulars</th>
                <th>Material Cost (Civil)</th>
                <th>Labour Cost (Civil)</th>
            ...
            @foreach ($percentage_sheet_floor_wise as $floor_wise_sheet)
                ...
                <tr>
                    ...
                    <td style="text-align: left"><strong>{{ $floor_wise_sheet?->boqCivilCalcProjectFloor?->boqCommonFloor?->name ?? '---' }}</strong></td>
            ...
            <tr>
                ...
                <td style="text-align: left"><strong>Other Related Cost</strong></td>
                <td>---</td>
                <td>---</td>
                <td>---</td>
