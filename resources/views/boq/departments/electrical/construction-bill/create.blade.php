        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="input-group input-group-sm input-group-primary">
                    ...
                    {{Form::text('work_order_no', old('work_order_no') ? old('work_order_no') : (!empty($constructionBill->workorder_id) ? $constructionBill->workorder->workorder_no : null),['class' => 'form-control','id' => 'work_order_no','autocomplete'=>"off",'placeholder' => 'Please Search Work Order No'])}}
                    {{Form::hidden('workorder_id', old('workorder_id') ? old('workorder_id') : (!empty($constructionBill->workorder_id) ? $constructionBill->workorder_id : null),['class' => 'form-control','id' => 'workorder_id','autocomplete'=>"off"])}}
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group input-group-sm input-group-primary">
            ...
            <div class="col-md-6">
                <div class="input-group input-group-sm input-group-primary">
                    ...
                    {{Form::text('project_name', old('project_name') ? old('project_name') : (!empty($constructionBill) ? $constructionBill->project?->name  : null),['class' => 'form-control','id' => 'project_name','placeholder'=>"Enter Project Name" ,'autocomplete'=>"off"])}}
            ...
            <div class="col-md-6">
                <div class="input-group input-group-sm input-group-primary">
                    ...
                    {{Form::text('supplier_name', old('supplier_name') ? old('supplier_name') : (!empty($constructionBill) ? $constructionBill->supplier?->name : null),['class' => 'form-control','id' => 'supplier_name','placeholder'=>"Enter Supplier Name" ,'autocomplete'=>"off"])}}
