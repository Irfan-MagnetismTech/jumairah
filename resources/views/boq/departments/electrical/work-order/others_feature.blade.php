...
@section('breadcrumb-button')
        <a href="{{route("boq.project.departments.electrical.workorder.technical_specification", ['project' => $project ,'workorder' => $workorder->id]) }}" data-toggle="tooltip" title="Edit Technical Specification" class="btn btn-out-dashed btn-sm btn-info"><i class="fas fa-long-arrow-alt-left"></i></a>
...
@section('content')
    {!! Form::open(['url' => route('boq.project.departments.electrical.workorder.other_feature.store',['project' => $project,'workorder' => $workorder->id]), 'method' => 'POST', 'class' => 'custom-form']) !!}
