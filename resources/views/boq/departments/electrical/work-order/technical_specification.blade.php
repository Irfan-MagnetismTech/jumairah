...
@section('breadcrumb-button')
    <a href="{{route("boq.project.departments.electrical.workorder.terms", ['project' => $project ,'workorder' => $workorder->id])}}" class="btn btn-out-dashed btn-sm btn-info" data-toggle="tooltip" title="Edit Terms"><i class="fas fa-long-arrow-alt-left"></i></a>
    <a href="{{route("boq.project.departments.electrical.workorder.other_feature", ['project' => $project ,'workorder' => $workorder->id])}}" class="btn btn-out-dashed btn-sm btn-info" data-toggle="tooltip" title="Edit Other Features"><i class="fas fa-long-arrow-alt-right"></i></a>
...
@section('content')
    {!! Form::open(['url' => route('boq.project.departments.electrical.workorder.technical_specification.store',['project' => $project,'workorder' => $workorder->id]), 'method' => 'POST', 'class' => 'custom-form']) !!}
