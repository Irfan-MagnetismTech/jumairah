...
@php
    ...
    $form_url = !empty($work_c->id) ? route('boq.project.departments.electrical.work_cs.update', ['project' => $project ,'work_c' => $work_c->id]) : route('boq.project.departments.electrical.work_cs.store',['project' => $project ]);
...
@section('breadcrumb-button')
    <a href="{{ route('boq.project.departments.electrical.work_cs.index', ['project' => $project ]) }}" class="btn btn-out-dashed btn-sm btn-warning"><i class="fas fa-database"></i></a>
@endsection
