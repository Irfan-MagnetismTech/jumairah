...
@section('breadcrumb-title')
    Showing information of CS# {{$work_c->id}}
@endsection
        ...
        <div class="col-lg-12">
            <div class="table-responsive">
                <table id="dataTable" class="table table-striped table-bordered">
                    ...
                    <tr style="background-color: #0C4A77;;color: white;"><td> <strong>Cs No.</strong> </td> <td> <strong>CS#{{ $work_c->id}}</strong></td></tr>
                    <tr><td> <strong>Effective Date</strong> </td> <td>  {{ $work_c->effective_date}}</td></tr>
                    <tr><td> <strong>Expiry Date</strong> </td> <td>  {{ $work_c->expiry_date}}</td></tr>
                    <tr><td> <strong>Remarks</strong> </td> <td>  {{ $work_c->remarks}}</td></tr>
                    <tr>
                        <td> <strong>Remarks</strong> </td>
                        <td><strong>
                        {{-- @foreach($work_c->workCsSuppliers as  $csProject)
            ...
            <div class="table-responsive">
                <table id="supplierTable" class="table table-striped table-sm text-center table-bordered" >
                    ...
                    <tr>
                        ...
                        <th> unit</th>
                        @foreach($work_c->csSuppliers as  $csSupplier)
                            <th>
                    ...
                    <tbody>
                    @foreach($work_c->csMaterials as $csMaterial)
                        <tr>
                            <td>
