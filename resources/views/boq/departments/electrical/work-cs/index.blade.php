...
@section('breadcrumb-button')
    <a href="{{ route('boq.project.departments.electrical.work_cs.create', ['project' => $project ]) }}" class="btn btn-out-dashed btn-sm btn-success"><i class="fa fa-plus"></i></a>
@endsection
            ...
            @foreach($cs as $key => $value)
                    <tr>
                        ...
                        <td>
                            {{-- <div class="icon-btn">
                                <nobr>
                                    <a href="{{ route("boq.project.departments.electrical.work_cs.edit", ['project' => $project,'work_c' => $value]) }}" data-toggle="tooltip" title="Edit" class="btn btn-outline-warning"><i class="fas fa-pen"></i></a>
                                   ...
                                   {!! Form::open(array('url' => route("boq.project.departments.electrical.work_cs.destroy", ['project' => $project,'work_c' => $value]),'method' => 'delete', 'class'=>'d-inline','data-toggle'=>'tooltip','title'=>'Delete')) !!}
                            ...
                            <div class="icon-btn">
                                <nobr>
                                    ...
                                    <a href="{{ url("boq/project/$project->id/departments/electrical/work_cs/approved/$value->id/1") }}" data-toggle="tooltip" title="Approve" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i></a>
                                    ...
                                    @if($value->approval()->doesntExist() || auth()->user()->hasAnyRole(['admin','super-admin']))
                                        ...
                                        @endif
                                    @endif()
                                    <a href="{{ route('boq.project.departments.electrical.work_cs.show',['project' => $project,'work_c' => $value]) }}" data-toggle="tooltip" title="Details" class="btn btn-outline-primary"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('boq.project.departments.electrical.work_cs.pdf', ['project' => $project,'work_c' => $value]) }}" title="PDF" class="btn btn-out-dashed btn-sm btn-success"><i class="fas fa-file-pdf"></i></a>
                                </nobr>
                            </div> 
                        </td>
                    </tr>
