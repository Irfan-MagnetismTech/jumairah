                        ...
                        <tbody>
                            @foreach ($sanitaryAllocations as $key => $sanitaryAllocation)
                                <tr>
                                    ...
                                    <td>
                                        {{ $sanitaryAllocation->master_fc }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->master_lw }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->child_fc }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->child_lw }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->common_fc }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->common_lw }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->small_toilet_fc }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->small_toilet_lw }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->kitchen_fc }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->kitchen_lw }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->commonArea }}
                                    </td>
                                    <td>
                                        {{ $sanitaryAllocation->total }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
