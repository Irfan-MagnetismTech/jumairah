...
@section('content')
    @if ($formType == 'bonus-sheet')
        {!! Form::open([
            'url' => 'hr/bonus-sheet/report',
            'method' => 'POST',
            'class' => 'custom-form',
            'files' => true,
    ...
    <div class="row">
        ...
        {{-- <div class="col-md-6 col-sm-12">
            <div class="input-group input-group-sm input-group-primary d-flex flex-column justify-content-between my-2" style="font-size: 14px;">
                <div>
                    <input class="checkbox report-type"  type="radio" name="report_type" id="daily-report" value="daily" checked> Daily OT Sheet
                </div>
                <div>
                    <input class="checkbox report-type"  type="radio" name="report_type" id="monthly-report" value="monthly" > Monthly OT Sheet
                </div>
                <div>
                    <input class="checkbox report-type"  type="radio" name="report_type" id="yearly-report" value="yearly" > Yearly OT Sheet
                </div>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="input-group input-group-sm input-group-primary">
                <label style="" class="input-group-addon" for="from_date"> From Date <span
                        class="text-danger">*</span></label>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="input-group input-group-sm input-group-primary">
                <label style="" class="input-group-addon" for="to_date"> To Date <span
                        class="text-danger">*</span></label>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="input-group input-group-sm input-group-primary">
                <label style="" class="input-group-addon" for="bonus_id">Bonus</label>
                {{ Form::select('bonus_id', $bonuses, old('bonus_id'), ['class' => 'form-control', 'id' => 'bonus_id', 'placeholder' => 'All', 'autocomplete' => 'off', '']) }}
                @error('bonus_id')
