...
@section('breadcrumb-button')
    <a class="btn btn-out-dashed btn-sm btn-warning" href="{{ route('bonus-process.index') }}"><i
...
@section('content')
    ...
    <div class="row">
        <div class="col-6">
            <div class="input-group input-group-sm input-group-primary">
                <label style="min-width: 22% !important; max-width:22% !important;" class="input-group-addon"
                    for="date">Date <span class="text-danger">*</span></label>
                {{ Form::text(
                    'date',
                    old('date') ? old('date') : (!empty($processed_bonus->date) ? $processed_bonus->date : now()->format('Y-m-d')),
                    ['class' => 'form-control date-picker', 'id' => 'date', 'autocomplete' => 'off', 'required'],
                ) }}
                @error('date')
        ...
        <div class="col-6">
            <div class="input-group input-group-sm input-group-primary">
                <label style="min-width: 22% !important; max-width:22% !important;" class="input-group-addon"
                    for="employee_id">Employee</label>
