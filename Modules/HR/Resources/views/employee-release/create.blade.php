...
<a class="btn btn-out-dashed btn-sm btn-warning" href="{{ route('employee-releases.index') }}"><i
...
<div class="col-12">
    <div class="input-group input-group-sm input-group-primary">
        ...
        {{ Form::select(
            'employee_id',
            $employees,
            old('employee_id') ? old('employee_id') : (!empty($employee_release) ? $employee_release->employee_id : null),
            [
...
<div class="col-6">
    <div class="input-group input-group-sm input-group-primary">
        ...
        {{ Form::select(
            'released_type_id',
            $released_types,
            old('released_type_id')
                ? old('released_type_id')
                : (!empty($employee_release->released_type_id)
                    ? $employee_release->released_type_id
                    : null),
            [
...
<div class="col-6">
    <div class="input-group input-group-sm input-group-primary">
        <label class="input-group-addon" for="last_present_day">Last Present Day <span
        ...
        {{ Form::date(
            ...
            [
                'class' => 'form-control',
                'id' => 'last_present_day',
                'placeholder' => 'Enter Last Present Date Here',
                'required',
            ],
        ) }}
