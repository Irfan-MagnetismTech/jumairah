...
<head>
    ...
    <title>Promotion Increment List Report </title>
</head>
            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2">Inc. Type</th>
                        <th colspan="2">Emp. Type</th>
                        ...
                        <th colspan="2">FA</th>
                        <th colspan="2">MA</th>
                        <th rowspan="2">Inc. Amount</th>
                        <th rowspan="2">Inc. Percentage</th>
                ...
                <tbody>
                    @foreach ($reportData as $key => $data)
                        ...
                        <tr>
                            ...
                            <td>{{ $data->incement_type }}</td>
                            <td>{{ $data->old_emp_type?->name }}</td>
                            <td>{{ $data->new_emp_type?->name }}</td>
                            <td>{{ $data->old_designation?->name }}</td>
                            <td>{{ $data->new_designation?->name }}</td>

                            <td>@money($data->old_gs)</td>
                            <td>@money($data->new_gs)</td>

                            <td>@money($data->old_bs)</td>
                            <td>@money($data->new_bs)</td>

                            <td>@money($data->old_hr)</td>
                            <td>@money($data->new_hr)</td>

                            <td>@money($data->old_ta)</td>
                            <td>@money($data->new_ta)</td>

                            <td>@money($data->old_fa)</td>
                            <td>@money($data->new_fa)</td>

                            <td>@money($data->old_ma)</td>
                            <td>@money($data->new_ma)</td>

                            <td>@money($data->increment_amount)</td>

                            <td class="text-center">{{ $data->increment_percentage }}%</td>

                            <td>{{ $data->increment_status ? 'Active' : 'Inactive' }}</td>
