...
@section('content')
    @if ($formType == 'leave-report')
        {!! Form::open([
            'url' => 'hr/leave-report/report',
            'method' => 'POST',
            'class' => 'custom-form',
            'files' => true,
    ...
    <div class="row">
        ...
        {{-- <div class="col-md-4 col-sm-12">
            <div class="input-group input-group-sm input-group-primary">
                <label style="" class="input-group-addon" for="leave_type_id">Leave Type</label>
                {{Form::select('leave_type_id', $leave_types, old('leave_type_id'),['class' => 'form-control','id' => 'leave_type_id', 'placeholder'=>"All", 'autocomplete'=>"off", ""])}}
                @error('leave_type_id')
