    ...
    <div class="container">
        @foreach ($employees as $key => $e)
            <div id="idcard-container">
                <div class="left-side">
                    <div class="left-logo-container" style="text-align: right">
                        <img src="/images/gil-logo-2.png" id="left-logo" style="width:54%;margin-right:10px; margin-top:10px;">
                    </div>
                    ...
                    <p class="emp_designation uppercase" style="font-size: 9px;text-align:center">{{ $e->emp_name }}</p>
                    <p class="emp_designation uppercase" style="font-size: 9px;text-align:center">HM Steel & Industry Ltd</p>
                    <br>
                    <div style="margin-left:20px">
                        <p style="font-size: 8px">ID  NO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                            {{ $e->emp_code }}</p>
                ...
                <div class="right-side">
                    <div class="right-side-inner">
                        <div class="right-logo-container" style="text-align: center">
                            <img src="{{ base_path('Modules/HR/Resources/views/idcard-appointment-letter/idcard-img/gil-logo.png') }}" id="right-logo" style="width:60%">
                        </div>
                        <div style="text-align: center">
                            ...
                            <br>
                            <p class="uppercase text-center" style="font-size: 8px">JOIN: {{$expired}}</p>
                            <hr style="margin-top:23px; margin-bottom:2px; text-align:center; width:80%" >
        ...
        <style>
            ...
            .left-side {
                ...
                height: 258px;
                float: left;
                /* background-image: url('/idcard/gil-id-1.png'); */
                background-image: url("{{ base_path('Modules/HR/Resources/views/idcard-appointment-letter/idcard-img/gil-id-12.png') }}");
