...
@section('title', 'Daily Attendance List Report')
...
@section('content')
    @if ($formType == 'daily-attendance-list')
        {!! Form::open([
            'url' => 'hr/daily-attendance-list/report',
            'method' => 'POST',
            'class' => 'custom-form',
            'files' => true,
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="input-group input-group-sm input-group-primary d-flex flex-wrap justify-content-between my-2"
                ...
                <div>
                    <input class="checkbox search-type" type="radio" name="search_type" id="shift-wise" value="shift">
                    Shift Wise
                </div>
