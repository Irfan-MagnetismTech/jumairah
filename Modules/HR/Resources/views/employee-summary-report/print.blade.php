    ...
    <htmlpageheader name="page-header">
        ...
        <div style="width: 24%; float:left;">
            <img class="float-right" style="height: 50px;"
                src="{{ asset(config('company_info.logo')) }}" alt="Golden ispat Logo">
        </div>
        <div style="width: 50%; float:left;">
            <div style="margin-top: 20px;">
                ...
                <p style="font-size: 12px; text-align: center; font-weight: bold;text-transform: uppercase; ">
                    Yearly Employee Summary Report
            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%">Total Late Day</th>
                        <th style="width: 10%">Total Late Hours</th>
                        <th style="width: 10%">Total Leave Balance</th>
                    </tr>
                ...
                <tbody>
                    @foreach ($reportData as $key => $data)
                        <tr>
                            ...
                            <td class="text-right">{{ $data->total_present }}</td>
                            <td class="text-right">{{ $data->total_absent }}</td>
                            <td class="text-right">{{ $data->total_late }}</td>
                            <td class="text-right">{{  gmdate('H:i:s', $data?->total_late_seconds); }}</td>
                            <td class="text-right">{{ $data->el+$data->cl+$data->sl+$data->ml }}</td>
