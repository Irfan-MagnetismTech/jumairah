BEGIN
    ...
    Truncate table temp_processed_salaries;
     ...
     INSERT INTO temp_processed_salaries(emp_id,employee_type_id, department_id, section_id, shift_id, designation_id, month, total_working_day, total_working_amount, total_late_hour, total_late_amount, total_ot_hour, total_ot_amount, adjustment_amount)
    SELECT id,employee_type_id,department_id,section_id,shift_id,designation_id,@month,null,null,null,null,null,NULL,NULL
     FROM employees
     WHERE is_active=1
