BEGIN
   ...
   UPDATE fix_attendances
    ...
    Insert Into processed_attendances (emp_id, emp_card_id, employee_type_id, department_id, section_id, sub_section_id, designation_id, shift_id, unit_id, floor_id, line_id, punch_date, time_in, time_out, late, ot_hour, remarks,com_id, status)
    SELECT  emp_id, emp_card_id, employee_type_id, department_id, section_id, sub_section_id, designation_id, shift_id, unit_id, floor_id, line_id, punch_date, time_in, time_out, late, ot_hour, remarks,@Com_User, status
    FROM temp_processed_attendances;

    Update processed_attendances
    set ot_hour = @Overtime
    where status in ('p','l') and punch_date = @Date;
